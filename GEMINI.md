...
key_files:
  ...
  - path: "_sass/list.scss"
    purpose: "Handles list-related styles."
  - path: "_sass/lunardrift.scss"
    purpose: "Main SASS file for theme customization and variables."
  - path: "_sass/syntax.scss"
    purpose: "Defines syntax highlighting styles."
  - path: "assets/css/main.scss"
    purpose: "Main entry point for CSS compilation."
